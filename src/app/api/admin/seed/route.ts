...
export async function POST(req: NextRequest) {
  try {
    ...
    const setting = await Setting.create({
      ...
      headerFooterRole: 'Full Stack Developer',
      serviceStat1Value: '99.9%',
      serviceStat1Label: 'Uptime & Performance',
      serviceStat2Value: 'Clean',
      serviceStat2Label: 'Architecture',
      serviceStat3Value: '24/7',
      serviceStat3Label: 'Support & Comm',
      projectStat1Value: 'Pixel',
      projectStat1Label: 'Precision UI',
      projectStat2Value: 'Fluid',
      projectStat2Label: 'Animations',
      projectStat3Value: 'Mobile',
      projectStat3Label: 'First Design',
      projectStat4Value: 'SEO',
      projectStat4Label: 'Optimized (A+)',
      expStat1Value: '10k+',
      expStat1Label: 'Hours Coding',
      expStat2Value: 'Agile',
      expStat2Label: 'Workflow',
      expStat3Value: 'Modern',
      expStat3Label: 'Tool Stacks',
      expStat4Value: 'Swift',
      expStat4Label: 'Resolution Rate',
      testiStat1Value: '5.0',
      testiStat1Label: 'Average Rating',
      testiStat2Value: '98%',
      testiStat2Label: 'Client Retention',
      testiStat3Value: '100%',
      testiStat3Label: 'Client Trust',
      testiStat4Value: 'Direct',
      testiStat4Label: 'Collaboration'
    });
